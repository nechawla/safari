    ...
    <form id="form1" runat="server">
        ...
        <br />
            ...
            <asp:Label ID="Address_info" runat="server" Text="ADDRESS:"></asp:Label>   
               <br />
                <br />
                <asp:Image ID="Address_image" runat="server" Height="20px" ImageUrl="~/resources/address.png" Width="20px" />
                <asp:Label ID="Add_label" runat="server" Text="138 Atlantis Linkingsport illnois 121164"></asp:Label>
                <br />
                <br />
                <asp:Label ID="Phone_label" runat="server" Text="PHONES:"></asp:Label>
                <br />
                <br />
                <asp:Image ID="Phone_image" runat="server" Height="20px" ImageUrl="~/resources/phone.png" Width="20px"/>
                <asp:Label ID="Ph_label" runat="server" Text="123 444 2234"></asp:Label>
                <br />
                <asp:Image ID="Workphone_image" runat="server" Height="18px" ImageUrl="~/resources/workphone.png" Width="20px" />
